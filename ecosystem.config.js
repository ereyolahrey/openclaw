module.exports = {
  apps: [{
    ...
    script: "src/agents/polymarket-trader.js",
    cwd: __dirname,
    restart_delay: 10000,
    max_restarts: 50,
    autorestart: true,
    watch: false,
    error_file: "logs/polymarket-err.log",
    ...
    script: "src/agents/ecommerce-agent.js",
    cwd: __dirname,
    restart_delay: 30000,
    max_restarts: 20,
    autorestart: true,
    watch: false,
    error_file: "logs/ecommerce-err.log",
    ...
    name: "skill-worker",
    script: "src/agents/skill-worker.js",
    cwd: __dirname,
    restart_delay: 10000,
    max_restarts: 50,
    autorestart: true,
    watch: false,
    error_file: "logs/skill-worker-err.log",
    out_file: "logs/skill-worker-out.log",
    merge_logs: true,
    time: true,
    env: {
      NODE_ENV: "production",
    ...
    name: "social-content",
    script: "src/agents/social-content.js",
    cwd: __dirname,
    restart_delay: 30000,
    max_restarts: 20,
    autorestart: true,
    watch: false,
    error_file: "logs/social-err.log",
